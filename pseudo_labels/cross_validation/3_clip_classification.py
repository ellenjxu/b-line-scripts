...
model_subfolder = ''
model_names = ['0201_pseudo-labels-fold_0', '0201_pseudo-labels-fold_1', '0201_pseudo-labels-fold_2', '0201_pseudo-labels-fold_3', '0201_pseudo-labels-fold_4']
dataset_split = 'val'
extension = ''

# define the detection settings
classification_threshold = 0.0  # for B-line presence in videos, was determined based on validation set result
...
for i, model_name in enumerate(model_names):  
    ...
    cases = split_df.loc[split_df['split'] == split]['Case'].to_list()
